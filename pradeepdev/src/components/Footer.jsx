...
function Footer() {
  return (
    <div className='px-4 md:px-8 lg:px-20 bg-gray-800 w-full h-24 flex justify-center items-center text-white' >
        <div className='text-center text-lg md:text-xl lg:text-2xl mr-10'>
